...
DsdvManetExample::CheckThroughput ()
{
  ...
  std::cout << Simulator::Now().GetSeconds() << "s Packets received " << totPackRecv << "\n";
  packetsReceived = 0;
...
//                             "Pause", RandomVariableValue (ConstantVariable (0.0)), "PositionAllocator", PointerValue (taPositionAlloc));
  mobility.SetMobilityModel ("ns3::RandomWaypointMobilityModel",
		  	  	  	  	  	  "Speed", RandomVariableValue (UniformVariable (0, m_nodeSpeed)),
                              "Pause", RandomVariableValue (ConstantVariable (30.0)),
