...
public:
  ...
  SecureBatmanHeader (uint8_t version = 0, UDFlags udFlags = _UD_FLAG, uint8_t timeToLive = 0, uint8_t gwFlags = 0, uint16_t sequenceNumber = 0, uint16_t gwPort = 0,
