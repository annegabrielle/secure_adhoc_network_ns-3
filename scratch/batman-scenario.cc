...
NS_LOG_COMPONENT_DEFINE ("batman-scenario");
...
private:
  ...
  void CollectData (std::string format, std::string experiment, std::string strategy, std::string input, std::string runID);
public:
...
void
BatmanSimulation::CollectData(std::string format, std::string experiment, std::string strategy, std::string input, std::string runID)
{
		...
		std::string strategy, std::string input, std::string runID)
{
	...
	InstallApplications ();
	CollectData (format, experiment, strategy, input, runID );
}
...
//	  devices = csma.Install (nodes);
	  ...
	  //  wifiPhy.EnablePcapAll ("batman-scenario");
}
