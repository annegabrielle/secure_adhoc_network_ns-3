...
RoutingProtocol::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::dsdv::RoutingProtocol")
    ...
    .AddAttribute ("RouteAggregationTime","Time to aggregate updates before sending them out (in seconds)",
                   ...
                   MakeTimeChecker ())
    .AddTraceSource ("Rx", "Receive DSDV packet.",
                   MakeTraceSourceAccessor (&RoutingProtocol::m_rxDsdvTrace))
    .AddTraceSource ("Tx", "Send DSDV packet.",
    			   MakeTraceSourceAccessor (&RoutingProtocol::m_txDsdvTrace));
  return tid;
}
